...
class ImageCaptureNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('usb_frame_rate', 1)
        self.declare_parameter('video_size', '1920x1080')
        self.declare_parameter('start_waypoint_index', 5)
        self.declare_parameter('stop_waypoint_index', 10)
        self.declare_parameter('image_prefix', 'nvcamtest_')
        self.declare_parameter('image_extension', '.jpg')

        # Get parameter values
        self.image_save_directory = self.get_parameter('folder_path').value
        self.camera_device = self.get_parameter('camera_device').value
        self.frame_rate = self.get_parameter('usb_frame_rate').value
        ...
        self.image_extension = self.get_parameter('image_extension').value
